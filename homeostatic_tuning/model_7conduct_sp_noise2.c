...
int main(int argc, char *argv[])
{
  ...
  while (num_run<Ntot+0.01)
    {
      //if (num_run!=2 && num_run!=6 && num_run!=10 && num_run!=30 && num_run!=32 && num_run!=33 && num_run!=34 && num_run!=35 && num_run!=37 && num_run!=39 && num_run!=44 && num_run!=46)
    {
      printf("%d \n",num_run);
      ...
      char sp_file1 [999];
      sprintf (sp_file1, "spikes1_mean_%g_sig(reset)_%g_tau_%g_coef_%g_num_%d.dat", mean, sigma2, tau_c, corr_coef, num_run);
      FILE *spfile1;
      spfile1 = fopen(sp_file1,"w");
      //
      char sp_file2 [999];
      sprintf (sp_file2, "spikes2_mean_%g_sig(reset)_%g_tau_%g_coef_%g_num_%d.dat", mean, sigma2, tau_c, corr_coef, num_run);
      FILE *spfile2;

...
int main(int argc, char *argv[])
{
  ...
  double g_gapp = atof(argv[8]);
  double g_gap[2]; g_gap[0] = g_gapp; g_gap[1] = g_gapp;
  ...
  char sp_file [999];
  sprintf (sp_file, "sp_gNa_%g_%g_gCaT_%g_%g_gCaS_%g_%g_gA_%g_%g_gKCa_%g_%g_gK_%g_%g_gH_%g_%g_gL_%g_%g_gsyn_%g_%g_Vhalf_%g_tsyn_%g_Esyn_%g_gap_%g.dat",g_Na1,g_Na2,g_CaT1,g_CaT2,g_CaS1,g_CaS2,g_A1,g_A2,g_KCa1,g_KCa2,g_K1,g_K2,g_H1,g_H2,g_L1,g_L2,g_syn1,g_syn2,V_half,tau_syn,E_syn,g_gapp);
  FILE *spfile;
  spfile = fopen(sp_file,"w");
  
  char V_file [999];
  sprintf (V_file, "V_gNa_%g_%g_gCaT_%g_%g_gCaS_%g_%g_gA_%g_%g_gKCa_%g_%g_gK_%g_%g_gH_%g_%g_gL_%g_%g_gsyn_%g_%g_Vhalf_%g_tsyn_%g_Esyn_%g_gap_%g.dat",g_Na1,g_Na2,g_CaT1,g_CaT2,g_CaS1,g_CaS2,g_A1,g_A2,g_KCa1,g_KCa2,g_K1,g_K2,g_H1,g_H2,g_L1,g_L2,g_syn1,g_syn2,V_half,tau_syn,E_syn,g_gapp);
  FILE *Vfile;
  ...
  while (current_time < total_time)
   {       
    ...
    for (nn=0;nn<2;nn++)
	 ...
	 sum_g[nn] = g_L[nn] + g_syn[nn]*Svar[nn] + g_gap[nn];
	 ...
	 if (nn==0)
	   {
	     sum_Eg[nn] += g_gap[nn]*V[1];
	   }
	 else
	   {
	     sum_Eg[nn] += g_gap[nn]*V[0];
	   }

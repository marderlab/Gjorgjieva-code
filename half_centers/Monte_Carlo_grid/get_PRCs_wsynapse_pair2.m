...
ll = 20; %1:53 %go through all the pairs
...
V_45887_syn = dlmread(sprintf('V_in1_%g_in2_%g_gsyn_%g_%g.dat',cell1,cell2,g_syn1,g_syn2));
Vs1 = V_45887_syn(V_45887_syn(:,1)==0,2); 
Vs2 = V_45887_syn(V_45887_syn(:,1)==1,2);
...
[CV1, num_sp1, period1, burst_dur1, first_spike1, last_spike1] = get_train_properties_sp(sp1,1);
[CV2, num_sp2, period2, burst_dur2, first_spike2, last_spike2] = get_train_properties_sp(sp2,1);
    ...
    for tt=1:length(Tdur_vec)
        ...
        for vv=1:length(Vsyn_vec)
            ...
            for frac=[0.05:0.05:0.95]                    
                ...
                x3 = intersect(x1+1,x2);
                sp2 = tot_T(x3); %get spike times
                [CV1, num_sp1, period1, burst_dur1, first_spike1, last_spike1] = get_train_properties_HCO(sp1,0,20);%16
                [CV2, num_sp2, period2, burst_dur2, first_spike2, last_spike2] = get_train_properties_HCO(sp2,0,20);%14
    ...
    for tt=1:length(Tdur_vec)
        ...
        for vv=1:length(Vsyn_vec)
            ...
            for frac=[0.05:0.05:0.95]                    
                ...
                x3 = intersect(x1+1,x2);
                sp2 = tot_T(x3); %get spike times
                [CV1, num_sp1, period1, burst_dur1, first_spike1, last_spike1] = get_train_properties_HCO(sp1,0,20);
                [CV2, num_sp2, period2, burst_dur2, first_spike2, last_spike2] = get_train_properties_HCO(sp2,0,20);

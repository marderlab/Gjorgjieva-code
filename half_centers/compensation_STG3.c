...
int main(int argc, char *argv[])
{
  ...
  //Compute the different time constants - all vectors, at each value of V
  double taumNa[2], tauhNa[2], taumCaT[2], tauhCaT[2], taumCaS[2], tauhCaS[2], taumA[2], tauhA[2], taumKCa[2], taumKd[2], taumsyn[2];
  double mNainf[2], hNainf[2], mCaTinf[2], hCaTinf[2], mCaSinf[2], hCaSinf[2], mAinf[2], hAinf[2], mKCainf[2], mKdinf[2], msyninf[2];
  double BAL_mNa[2], BAL_hNa[2], BAL_mCaT[2], BAL_hCaT[2], BAL_mCaS[2], BAL_hCaS[2], BAL_mA[2], BAL_hA[2], BAL_mKCa[2], BAL_mKd[2], BAL_msyn[2], newBAL_msyn[2];
  ...
  double amNa[2], ahNa[2], amCaT[2], ahCaT[2], amCaS[2], ahCaS[2], amA[2], ahA[2], amKCa[2], amKd[2], amsyn[2];
  double bmNa[2], bhNa[2], bmCaT[2], bhCaT[2], bmCaS[2], bhCaS[2], bmA[2], bhA[2], bmKCa[2], bmKd[2], bmsyn[2];
  ...
  */
  ...
  A[1][1] = (bmKd[X2]-amKd[X2]) * (-4*get_power(mKdinf[X2],3)*(V[X2]-VK) * dXinf(V[X2],12.3,-11.8)); 
  ...
  */
  ...
  c[2] = BALu[X1]  - ((1-bmNa[X1])*BAL_mNa[X1]  + (1-bhNa[X1])*BAL_hNa[X1] + (1-bmCaT[X1])*BAL_mCaT[X1] + (1-bhCaT[X1])*BAL_hCaT[X1] + (1-bmCaS[X1])*BAL_mCaS[X1] + (1-bhCaS[X1])*BAL_hCaS[X1] + (1-bmsyn[X1])*newBAL_msyn[X1]);

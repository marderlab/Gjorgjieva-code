...
int main(int argc, char *argv[])
{
  ...
  char V_file [999];
  sprintf (V_file, "V1_mean_%g_sig_%g_gNa_%g_rat1_%g_%g_rat2_%g_%g_rat3_%g_%g_gsyn_%g_%g_corr_%g_tc_%g_dt_%g_num_%d.dat", mean, sigma, g_Na, ratio1, ratio1_cell2, ratio2, ratio2_cell2, ratio3, ratio3_cell2, g_syn1, g_syn2, corr_coef, tau_c, dt, num_run);
  FILE *Vfile;
  Vfile = fopen(V_file,"w");
  
  char V_file2 [999];
  sprintf (V_file2, "V2_mean_%g_sig_%g_gNa_%g_rat1_%g_%g_rat2_%g_%g_rat3_%g_%g_gsyn_%g_%g_corr_%g_tc_%g_dt_%g_num_%d.dat", mean, sigma, g_Na, ratio1, ratio1_cell2, ratio2, ratio2_cell2, ratio3, ratio3_cell2,g_syn1, g_syn2,  corr_coef, tau_c, dt, num_run);
  FILE *Vfile2;
